...
namespace YM::RSS /* Rhythm Sound Source */
{
	/*
		The Yamaha Rhythm Sound Source is incorporated into the following products:
		- YM2608
		- YMF288

		It is a built-in ADPCM-A unit with 6 fixed instrument channels:
		1. Bass drum
		2. Snare drum
		3. Top cymbal
		4. High hat
		...
		The unit ouputs at ~18.5kHz, with the exception of the tom and rim shot. They run at half the frequency.
		There is a fixed (M / 6 / 24 / 3) clock divider. 

		The internal 8KB instrument ROM has not been dumped, but it has been recreated
		from encoding the chip's output. This should create a 100% binary compatible output.
		(credits: unknown)
	*/

/* RSS instrument start / end offsets */
const uint16_t InstrumentOffsets[] =
{
...
/* RSS 8KB instrument ROM */
static const uint8_t InstrumentROM[0x2000] =
{
	/* Bass drum */
